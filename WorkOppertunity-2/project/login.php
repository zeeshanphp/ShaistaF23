                        ...
                        <div class="card-body">
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <table class="table table-borderless">
                                    ...
                                    <tr>
                                        <td></td>
                                        <td><input type="submit" name="add_user" class="btn btn-success text-white w-100 bg-gradient bg-banner " value="Login As Customer" /></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td><a href="register.html" class="text-primary">Create Account</a></td>
                                    </tr>
                                </table>
                            </form>
