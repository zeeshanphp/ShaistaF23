...
if (isset($_POST['update_items'])) {
    ...
    $pcat = $_POST['pcat'];
    $pqty = $_POST['pqty'];
    $query = "UPDATE products SET pname='$pname',pprice='$pprice',pcat='$pcat',photo='$img', total_stock='$pqty' WHERE pId='$id'";
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td><input type="number" class="form-control" name="pqty" value="<?php echo $row['total_stock']; ?>"></td>
                        </tr>
                        <tr>
