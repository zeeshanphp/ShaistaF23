...
if(isset($_POST['admin'])){
	...
	$password=$_POST['password'];
			$query = "insert into admin (fullname,username,contact,email,pass)values('$fullname','$username','$contact' , '$email' , '$password') ";
	...
	<body style="background:gainsboro;">
		...
		<div class="navbar navbar-expand-lg navbar-dark bg-primary">
			...
			<table class="table table-striped" style="width:600px; margin-left:350px;">
					...
					<tr>
						<td></td>
						<td><input type="SUBMIT" value="SIGN UP" name="admin" class="btn btn-primary"/></td>
					</tr>
				</table>
		</form>
