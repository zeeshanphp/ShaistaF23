...
$message = "";
$food_id = $_GET['foodId'];
$total_dish_cost = mysqli_query($conn, "SELECT SUM(price) AS total_price FROM food_ingredients WHERE foodId='$food_id '");
                    ...
                    <form method="post">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="submit" name="add_ingredient" class="btn btn-primary w-100 mt-4" value="Add Purchases">
                                </td>
                            </tr>
                        </table>
                    </form>
