...
if (isset($_POST['add_items'])) {
  ...
  $model = $_POST['vmodel'];
  $query = "insert into  parts(pname,pprice,photo,pcat,vehname,vehmodel,sellerId) values('$pname' , '$pprice', '$img' , '$pcat','$veh_name','$model' , '$id')";
...
<body>
  <nav class="container-fluid py-3 nav-back">
    <div class="row">
      <div class="col-md-8">
        <h4>SELLER PANNEL &nbsp&nbsp Sale Purchase of Automobiles and Spare Parts </h4>
      </div>
      <div class="col-md-4">
