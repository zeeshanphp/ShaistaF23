...
if (isset($_POST['add_user'])) {
    ...
    if (filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        if (mysqli_query($conn, $query)) {
            $rmessage = " <b> Teanant Registered Successfully &nbsp  &nbsp <a href='login.php'>Go To Login Page</a> </b>";
        }
    } else {
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table table-borderless">
                            ...
                            <tr>
                                <td></td>
                                <td><input type="submit" name="add_user" class="btn-success bg-gradient btn w-100" value="Register As User" /></td>
                            </tr>
                        </table>
                    </div>
                </div>
