...
if (isset($_POST['login_user'])) {
    ...
    $query = "SELECT * FROM faculity_member WHERE username='$username' AND password='$password'";
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST">
                                    ...
                                    <div class="form-group py-3">
                                        <a href="register_faculity.php" class="btn-info bg-gradient btn w-100">Register New Faculity</a>
                                    </div>
