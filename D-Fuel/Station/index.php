                    ...
                    <div class="col-md-4 py-4">
                        ...
                        <form method="POST">
                            ...
                            <div class="form-group form-button">
                                <input type="submit" name="login_user" class="btn btn-primary btn-block" value="LOGIN" />
                            </div>
                            <div class="form-group">
                                <a href="register_manager.php" class="btn btn-success btn-block">REGISTER AS A MANAGER</a>
                            </div>
                            <div class="form-group">
                                <a href="../" class="btn btn-warning btn-block">GO TO USER PANNEL</a>
                            </div>
                        </form>
